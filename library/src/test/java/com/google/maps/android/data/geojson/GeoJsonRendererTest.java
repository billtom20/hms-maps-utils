...
public class GeoJsonRendererTest {
    ...
    public void setUp() throws Exception {
        GeoJsonParser parser = new GeoJsonParser(GeoJsonTestUtil.createFeatureCollection());
        ...
        mLayer = new GeoJsonLayer(mMap1, GeoJsonTestUtil.createFeatureCollection());
    ...
    public void testDefaultStyleClickable() {
        ...
        for (Feature f : mRenderer.getFeatures()) {
            Assert.assertTrue(((GeoJsonFeature)f).getPolylineOptions().isClickable());
            Assert.assertTrue(((GeoJsonFeature)f).getPolygonOptions().isClickable());
        }
    }
    ...
    public void testCustomStyleNotClickable() throws Exception {
        ...
        for (Feature f : renderer.getFeatures()) {
            Assert.assertFalse(((GeoJsonFeature)f).getPolylineOptions().isClickable());
            Assert.assertFalse(((GeoJsonFeature)f).getPolygonOptions().isClickable());
        }
    }
}
