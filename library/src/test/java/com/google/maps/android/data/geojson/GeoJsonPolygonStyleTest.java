...
public class GeoJsonPolygonStyleTest {
    ...
    public void testDefaultPolygonStyle() {
        ...
        Assert.assertNull(polygonStyle.getStrokePattern());
        ...
        Assert.assertTrue(polygonStyle.isClickable());
    }
    ...
    public void testDefaultGetPolygonOptions() {
        ...
        Assert.assertNull(polygonStyle.toPolygonOptions().getStrokePattern());
        assertEquals(10.0f, polygonStyle.toPolygonOptions().getStrokeWidth(), 0);
        Assert.assertTrue(polygonStyle.toPolygonOptions().isVisible());
        assertEquals(0.0f, polygonStyle.toPolygonOptions().getZIndex(), 0);
        Assert.assertTrue(polygonStyle.toPolygonOptions().isClickable());
    }
}
