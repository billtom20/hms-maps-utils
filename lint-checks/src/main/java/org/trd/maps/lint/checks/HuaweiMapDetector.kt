...
package org.trd.maps.lint.checks
...
class HuaweiMapDetector : Detector(), SourceCodeScanner  {
    ...
    override fun visitMethodCall(context: JavaContext, node: UCallExpression, method: PsiMethod) {
        ...
        if (!evaluator.isMemberInClass(method, "com.huawei.hms.maps.HuaweiMap")) {
            return
        }
        context.report(
    ...
    companion object {
        ...
        val POTENTIAL_BEHAVIOR_OVERRIDE = Issue.create(
            ...
            explanation = """
                ...
                window, rather than invoking `HuaweiMap#setInfoWindowAdapter(...)`, you would need
